...
public class PassengerProgressBoard : MonoBehaviour
{
    ...
    public ItemSpawnPoint flashlight, spray, screwdriver;
    ...
    void Update()
    {
        ...
        int items = Acquired(flashlight) + Acquired(spray) + Acquired(screwdriver);
        ...
        if (keys == 3 && items == 3 && locks == 3 && puzzles == 2) text += "\nROOM COMPLETE";
